...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup: function setup() {
    var verbiage = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)([]);
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              finish();
              _context.next = 3;
              return Nova.request().get('/nova-vendor/onboardingcard/verbiage');
            case 3:
              _context.next = 5;
              return _context.sent.data;
            case 5:
              verbiage = _context.sent;
              verbiage.forEach(function (element) {
                steps.value.push({
                  attachTo: {
                    element: "#".concat(element.id)
                  },
                  content: {
                    title: element.title,
     ...
     * 
     */
    var setIdAttribute = function setIdAttribute() {
      var element = document.querySelector("#nova > div:nth-child(2) > div.hidden.lg\\:block.lg\\:absolute.left-0.bottom-0.lg\\:top-\\[56px\\].lg\\:bottom-auto.w-60.px-3.py-8 > div > div:nth-child(2) > div > div");
      var element2 = document.querySelector("#nova > div:nth-child(2) > div.p-4.md\\:py-8.md\\:px-12.lg\\:ml-60.space-y-8 > div.relative > div.bg-white.dark\\:bg-gray-800.rounded-lg.shadow > div.relative");
      var element3 = document.querySelector("#nova > div:nth-child(2) > div.p-4.md\\:py-8.md\\:px-12.lg\\:ml-60.space-y-8 > div.relative > div.flex > div.w-full.flex.items-center.mb-6 > div > a");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_VOnboardingWrapper, {
    ref: "wrapper",
    steps: _ctx.steps
  }, null, 8 /* PROPS */, ["steps"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    "class": "btn-start",
    onClick: _cache[0] || (_cache[0] = function ($event) {
      return _ctx.start();
    })
  }, "start the tour")])], 64 /* STABLE_FRAGMENT */);
}
...
Nova.booting(function (app, store) {
  app.component('onboardingcard', _components_Card__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
...
const _sfc_main$1 = (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(_, { slots }) {
    ...
    const nextStep = (0,vue__WEBPACK_IMPORTED_MODULE_0__.inject)("next-step", () => {
    });
    const previousStep = (0,vue__WEBPACK_IMPORTED_MODULE_0__.inject)("previous-step", () => {
    });
    const exit = (0,vue__WEBPACK_IMPORTED_MODULE_0__.inject)("exit", () => {
    });
    ...
    const isFirst = (0,vue__WEBPACK_IMPORTED_MODULE_0__.inject)("is-first-step");
    const isLast = (0,vue__WEBPACK_IMPORTED_MODULE_0__.inject)("is-last-step");
    const step = (0,vue__WEBPACK_IMPORTED_MODULE_0__.inject)("step", {});
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(() => step.value, (_2, oldStep) => {
      var _a;
      if (!((_a = slots.default) == null ? void 0 : _a.call(slots)))
        return;
      beforeStepEnd(oldStep);
    });
    const stepElement = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(null);
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.onMounted)(beforeStepStart);
    return {
      stepElement,
      onNext,
      onPrevious,
      ...
      _ctx.step ? (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderSlot)(_ctx.$slots, "default", { key: 0 }, () => [
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [
          ...
          (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_10, [
            !_ctx.isFirst && _ctx.isButtonVisible.previous ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
              key: 0,
              type: "button",
            ...
            }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.isLast ? _ctx.buttonLabels.finish : _ctx.buttonLabels.next), 1)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("", true)
          ])
        ])
...
const _sfc_main = (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(props, { expose, emit }) {
    ...
    const destroyIsFinishedWatcher = (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(isFinished, (newValue) => {
      if (!newValue)
        return;
      exit();
    ...
    const mergedOptions = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => merge({}, defaultVOnboardingWrapperOptions, props.options));
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.provide)("options", mergedOptions);
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.provide)("step", activeStep);
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.provide)("next-step", toNextStep);
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.provide)("previous-step", toPreviousStep);
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.provide)("exit", exit);
    const isFirstStep = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => index.value === 0);
    const isLastStep = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => index.value === props.steps.length - 1);
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.provide)("is-first-step", isFirstStep);
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.provide)("is-last-step", isLastStep);
    return {
      index,
      activeStep,
      toPreviousStep,
...
/* harmony import */ var _var_www_html_findexTest_nova_components_Onboardingcard_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfindex_onboardingcard"] = self["webpackChunkfindex_onboardingcard"] || [];
